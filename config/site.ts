...
export const siteConfig = {
  name: 'SuperHelindo Jaya',
  description: 'Authorized Sole Agent of Hyundai Elevator in Indonesia',
  url: 'https://superhelindojaya.com',
  public_logo: '/logo.png',
  public_logo_square: '/logo-square.png',
